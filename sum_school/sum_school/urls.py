...
urlpatterns = [
    ...
    path('dashboard/<str:course_id>/assignment/' , main_views.assignmentRedirect , name='assignmentRedirect'),
    path('dashboard/<str:course_id>/assignment/<int:m>' , main_views.assignment , name='assignment'),
    path('dashboard/<str:course_id>/assignment/upload' , main_views.assignmentCreate , name='upload_assignment'),
